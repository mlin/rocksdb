...
class TwoLevelIterator: public Iterator {
 public:
  TwoLevelIterator(Iterator* index_iter, BlockFunction block_function,
                   ...
                   bool for_compaction, bool can_prefetch);
...
TwoLevelIterator::TwoLevelIterator(
    ...
    const InternalKeyComparator& internal_comparator, bool for_compaction, bool can_prefetch)
...
void TwoLevelIterator::PrefetchThread() {
  ...
  while (true) {
    ...
    Iterator* iter = (*block_function_)(arg_, options_, soptions_, internal_comparator_,
                                          Slice(data_block_handle_to_prefetch),
                                          for_compaction_);
    delete iter;
  }
}
...
Iterator* NewTwoLevelIterator(Iterator* index_iter,
  ...
  return new TwoLevelIterator(index_iter, block_function, arg, options,
                              soptions, env, internal_comparator, for_compaction, can_prefetch);
}
